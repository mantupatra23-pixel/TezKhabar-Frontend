        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-brand-surfaceDark">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-brand-sage">
              <li><Link href="/category/india" className="hover:text-brand-cream">National & India</Link></li>
              <li><Link href="/category/politics" className="hover:text-brand-cream">Politics & Policy</Link></li>
              <li><Link href="/category/business" className="hover:text-brand-cream">Business & Markets</Link></li>
              <li><Link href="/category/technology" className="hover:text-brand-cream">Technology & AI</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-brand-sage">
              <li><Link href="/about" className="hover:text-brand-cream">About TezKhabar</Link></li>
              <li><Link href="/editorial-policy" className="hover:text-brand-cream">Editorial & AI Policy</Link></li>
              <li><Link href="/privacy" className="hover:text-brand-cream">Privacy Policy</Link></li>
              <li><Link href="/terms" className="hover:text-brand-cream">Terms of Service</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form action="#" className="flex flex-col space-y-2" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
